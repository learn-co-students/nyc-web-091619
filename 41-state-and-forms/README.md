...
- [ ] Explain how we use controlled forms
...
1. Modal
  - Have button that says "New Listing!"
  - When clicked, opens a modal that displays the form
  - Submitting the form closes the form
2. Distinct "new" page
  - From the navbar, there are nav links
  - Cliking on the "new Listing" nav link takes you to page
  - Submitting form takes you back to see all listings
